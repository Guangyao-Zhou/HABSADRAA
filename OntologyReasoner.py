...
class OntReasoner():
    ...
    def is_negated(self, word, words_in_sentence):
        ...
        path_to_models_jar = 'data/externalData/stanford-parser-full-2018-02-27/stanford-parser-4.0.0-models.jar'
